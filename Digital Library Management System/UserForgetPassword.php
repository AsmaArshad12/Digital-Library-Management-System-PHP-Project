     ...
     $_SESSION['email'] = $email;
            ...
            $result= mysqli_query($con, $sql);
              ...
              if(mysqli_num_rows($result)>0)
              {
                  ...
                  echo "<script>window.location='UserResetPassword.php';</script>";
            
        } else {
            echo "<script>window.location='UserForgetPassword.php';alert('Invalid Email');</script>";
        }
    }
    ...
    <form  method="post">
        ...
        <div class="form-group mb-4 ">
            ...
            <input type="submit" name="submit" class="btn btn-primary mr-3" value="Forget Password" style="width:20%">
              ...
              <a href="UserRegistration.php" role="button" class="btn btn-primary mr-5" style="width:20%">Cancel</a>
        </div>
