...
if (mysqli_num_rows($result)>0) {
    $row= mysqli_fetch_array($result);
     echo "<script>window.location='LibrarianHomePage.php';alert('Librarian Login Successfully');</script>";
}

else
{
    echo "<script>window.location='LibrarianLogin.php';alert('Invalid Email And Password');</script>";
}
}
?>
...
<body  style="background-color:#6CBCE7">
   ...
   <br><br>
        <div class="container p-3 my-3 bg-white " style="border-radius:15px;width:50%">
             <br>           
<h2 style="color:black;text-align:center;"> Librarian Login </h2>
   <br>
