...
if (isset($_POST['submit'])) { 
    ...
    $status= "Pending";
            ...
            $sql = "INSERT INTO userregistration (Name, Email, Password, Status) VALUES ('$name','$email','$password','$status')";
            if (mysqli_query($con, $sql)) {
                
                echo "<script>alert('User Registration request is Pending')</script>";
...
<br><br>
 ...
 <div class="container p-3 my-3 bg-white " style="border-radius:15px;width:50%">
    ...
    <h2 style="color:black;text-align:center;"> Student Registration </h2>
    <br>
