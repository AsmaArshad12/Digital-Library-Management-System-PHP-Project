...
<body  style="background-color:#6CBCE7">
    ...
    <center>
<br><br>
    <h4>Student Registration Request</h2>
        <br>   
        <form method="post">
...
while($row= mysqli_fetch_array($x))
{
    ...
    <td><a class="btn btn-success" role="button" href="userapproval.php?id=<?php echo $row['Id']; ?>">Approved</a>

<a class="btn btn-success" role="button" href="userdecline.php?id=<?php echo $row['Id']; ?>">Decline</a>
    </td>
