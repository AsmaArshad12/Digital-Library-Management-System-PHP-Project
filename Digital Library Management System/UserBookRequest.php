...
$query="Insert into booksrequest(Name, Email, BookTitle, Date, Days, Status) values('$name', '$email','$title','$date', '$days','$status' )";
 if (mysqli_query($con, $query)) {
      ...
      echo "<script>window.location='UserBookRequest.php';alert('Invalid Data');</script>";
   }
 }
?>
...
<center>
    ...
    <label style="margin-right: 300px">User Name</label>  
    <div class="form-group mb-4 ">
      ...
      <label style="margin-right: 340px">Email</label> 
     <div class="form-group mb-4 ">
    ...
    <label style="margin-right: 315px">Book Title</label> 
    <div class="form-group mb-4 ">
    ...
    <label style="margin-right: 340px">Days</label> 
        <div class="form-group mb-4 ">
